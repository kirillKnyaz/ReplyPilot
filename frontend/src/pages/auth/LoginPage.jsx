...
function LoginPage() {  
  ...
  return (<div className="d-flex flex-column w-100 vh-100 justify-content-center align-items-center">
    ...
    <form onSubmit={handleLogin} className="w-100 d-flex flex-column justify-content-center align-items-center mb-5 card px-3 py-4 rounded-4" style={{ maxWidth: 400 }}>
      <h2>Login</h2>
      <input
        type="email"
